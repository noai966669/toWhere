...
//    _assetPicker=[[AssetPicker alloc] init];
//    _assetPicker.oneAssetPickerDelegate=self;
...
//    if (images.count>0){
//        UIImage *aImage=images[0];
//        [_btnOfHeadImage setImage:aImage forState:UIControlStateNormal];
//    }
//}
...
//    UIActionSheet *aUIActionSheet=[[UIActionSheet alloc]initWithTitle:@"选择头像照片来源" delegate:self cancelButtonTitle:@"取消选择" destructiveButtonTitle:@"哈哈" otherButtonTitles:@"从相册选取","拍照获得", nil ];
//    [aUIActionSheet showInView:self.view];
//}
...
//            manager.responseSerializer.acceptableContentTypes = [NSSet setWithObject:@"text/html"];
            //传入的参数
            NSDictionary *parameters = @{@"c":@"XXXX",@"a":@"XXXX"};
            //你的接口地址
            NSString *url=@"http://121.42.12.154/index.php";
            //发送请求
            [manager POST:url parameters:nil constructingBodyWithBlock:^(id<AFMultipartFormData>  _Nonnull formData) {
                NSData *imgData=UIImagePNGRepresentation(portraitImg);
                [formData appendPartWithFileData:imgData name:@"a" fileName:@"avatar.png" mimeType:@"image/png"];
