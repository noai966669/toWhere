...
//            aDetailDeliveryViewController.img.image=[UIImage imageNamed:appDelegate.code];
//            
//            aDetailDeliveryViewController.detail.text =  [NSString stringWithFormat:@"%@%@",[aDetailDeliveryViewController getNameByCode:appDelegate.code],number.text];
//            
 ...
 //            getNameByCode(aMDeliveryHistory.code)+aMDeliveryHistory.number
